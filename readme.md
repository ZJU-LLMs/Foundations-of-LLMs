...
当前版本共包含两个文件夹，<a href="https://github.com/ZJU-LLMs/Foundations-of-LLMs/tree/readme_fix/大语言模型中文版">大语言模型中文版</a>文件夹中包含了完整的本书PDF版本以及分章节的PDF版本。而<a href="https://github.com/ZJU-LLMs/Foundations-of-LLMs/tree/readme_fix/大语言模型相关论文">大语言模型相关论文</a>文件夹中包含了各个章节的相关论文，当前正处于不断更新中。
